...
function EducationalFeatures() {
  ...
  function TutionClass() {
    const features = [
      ...
      {
        title: "+2 Level Tuition",
        description: "Science, Accounts and Mathematics"
      },
      {
        title: "Bachelor's Tuition",
        description: "Score great grades in your university exams"
      }
    ];
  
    return (
      <div className="w-full bg-background text-foreground p-7 sm:p-6 md:p-8">
        <h1 className="text-2xl sm:text-3xl font-bold text-center mb-3">About Tuition Class</h1>
        <p className="text-center text-muted-foreground mb-6">
        We are helping students from grade 5 to bachelor’s level secure great grades in their exams. Enroll with us and see your children’s grades improving for yourself.
        </p>
